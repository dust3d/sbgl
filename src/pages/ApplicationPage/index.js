...
{ key:  '4411', value:  'NAICS 441', text:  'Motor Vehicle and Parts Dealers NAICS 441'}, 
{ key:  '4421', value:  'NAICS 442', text:  'Furniture and Furnishings Stores NAICS 442'}, 
{ key:  '4431', value:  'NAICS 443', text:  'Electronics and Appliance Stores NAICS 443'}, 
...
{ key:  '45321', value:  'NAICS 4532', text:  'Office Supplies, Stationery, and Gift Stores NAICS 4532'}, 
{ key:  '45322', value:  'NAICS 4532', text:  'Pet Supply & Services NAICS 4532'}, 
{ key:  '4539', value:  'NAICS 4539', text:  'Other Products NAICS 4539'}, 
{ key:  '812', value:  'NAICS 812', text:  'Personal Care Services NAICS 812'}, 
{ key:  '441', value:  'NAICS 44', text:  'Financial Services NAICS 521-525'}, 
{ key:  '4422', value:  'NAICS 44', text:  'Lodging NAICS 7211'}, 
{ key:  '4432', value:  'NAICS 44', text:  'Entertainment Facilities NAICS 3121'}, 
{ key:  '881', value:  'NAICS 881', text:  'Repair Services NAICS 811'}, 
{ key:  '4412', value:  'NAICS 441', text:  'Automotive Services NAICS 441'}, 
{ key:  '4931', value:  'NAICS 493', text:  'Parking or Storage Facility NAICS 493'}, 
...
{ key:  '4932', value:  'NAICS 493', text:  'Warehouse & Freight NAICS 493'}, 
...
const grossAnnualRevenueOptions = [
...
const footTrafficQuoteWeighting = {
  'foot50': 1.2,
  'foot51': 1.5,
  'foot201':1.6,
  'foot500':1.8,
...
export class ApplicationPage extends Component {
  ...
  handleSubmit(e, {name, value}) {
    console.log('submit worked', value);
    // this.setState({ submittedIndustry: industry, submittedPayroll: payroll })
       this.setState({ error: false, errorMessage: undefined, [name]: value });
  ...
  render() {
      console.log('HEY FOOT TRAFFIC', footTrafficQuoteWeighting['foot1000']);
    ...
    return (
      ...
      <Menu.Item as={Link} to='/contact'>Contact Us</Menu.Item>
                ...
                {error && (
                  ...
                  <pre>{JSON.stringify({ industry, payroll }, null, 2)}</pre>
                  <strong>onSubmit:</strong>
                  <pre>{JSON.stringify({ submittedIndustry, submittedPayroll }, null, 2)}</pre>
                  <Message
                  success
                  size='large'
